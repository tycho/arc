...
Begin VB.UserControl SierraList 
   BackColor       =   &H00081421&
   ClientHeight    =   3495
   ClientLeft      =   0
   ClientTop       =   0
   ...
   Begin ComctlLib.ImageList ilStars 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":0152
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":01A8
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ilStars 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   2
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":16BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":1710
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ilStars 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   2
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":27A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":27F8
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ilStars 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   2
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":340A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":3460
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ilStars 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   2
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":3BF2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":3C48
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList imgIcons 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   4
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":3F5A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":42AC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":45FE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":4950
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ilStars 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   2
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":4CA2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "SierraList.ctx":4CF8
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Public Sub AddServer(ServerName As String, Map As String, Players As Integer, MaxPlayers As Integer, Ping As Integer, Official As Boolean, Locked As Boolean)
    Dim I As Integer
